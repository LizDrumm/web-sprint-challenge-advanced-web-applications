...
token is used to hold data such as username and passowrrd 

2. What steps can you take in your web apps to keep your data secure?
keep information protected using private routes 

3. Describe how web servers work.

information is sent from the user to the backend who parses the data and sends the information requested back to the user 
